...
/** A prefeitura permite empréstimos a seus funcionários onde o valor máximo da prestação não ultrapasse 30%
 *  do salário. Dados os valores do salário, do empréstimo e quantidade de prestações; informar se o empréstimo
 *  é permitido ou não. Não considere acréscimo de juros. */
